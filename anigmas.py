...
def ici_result(df):
    ...
    return actions.return_mean_and_var_from_df(df_ici)

def risc_result(df):
    risc_cols=("heg_4","heg_14","heg_18","heg_19")
    df_risc=df.filter(items=risc_cols)
    return actions.return_mean_and_var_from_df(df_risc)
...
def future_negetive_past_result(df):
    ...
    return actions.return_mean_and_var_from_df(df_future_negetive_past)
...
def future_positive_past_result(df):
    ...
    return actions.return_mean_and_var_from_df(df_future_positive_past)
...
def future_fatalic_present_result(df):
    ...
    return actions.return_mean_and_var_from_df(df_future_fatalic_present)
...
def future_hedonistic_present_result(df):
    ...
    return actions.return_mean_and_var_from_df(df_future_hedonistic_present)
...
def future_future_result(df):
    ...
    return actions.return_mean_and_var_from_df(df_future_future)
